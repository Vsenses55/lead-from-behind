import svgPaths from "./svg-q6bvmyd1kg";

export default function Footer({ className }: { className?: string }) {
  return (
    <div className={className || "bg-[#28324b] relative w-[1920px]"} data-name="Footer">
      <div className="content-start flex flex-wrap gap-y-[132px] items-start justify-between px-[240px] py-[60px] relative w-full">
        ...
        <div className="absolute bottom-[19.35px] h-[45.1px] right-[20px] w-[45px]" data-name="Button Back to Top">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45 45.1002">
            <g clipPath="url(#clip0_48_147)" id="Button Back to Top">
