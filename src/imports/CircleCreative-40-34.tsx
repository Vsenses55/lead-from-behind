...
export default function CircleCreative() {
  return (
    <div className="content-center flex flex-wrap gap-y-0 items-center justify-center pr-[200px] relative size-full" data-name="Circle Creative">
      <div className="content-stretch flex items-center mr-[-200px] p-[10px] relative shrink-0" data-name="Img">
