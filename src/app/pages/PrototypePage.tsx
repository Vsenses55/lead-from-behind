        ...
        <div className="h-full flex items-center justify-between px-4 md:px-9">
          ...
          <div className="hidden md:flex items-center gap-[19px] h-[30px]">
            <div className="flex items-center justify-center h-full">
              <p className="text-[20px] leading-[32px] text-[#28324b] uppercase tracking-[0.3px] whitespace-nowrap" style={{ fontFamily: 'Avenir, sans-serif', fontWeight: 500, textShadow: '0.25px 0 0 currentColor' }}>
                How to Prevent
              </p>
            </div>
